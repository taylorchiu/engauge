...
share a unique URL with their students, and watch as an animate chart displays and updates the class aggregate date.  Students
...
- ACCESS CODES: There is not yet a feature to ask for and verify an access code. Any one with the url can score any other lesson.
...
- COMMENTS: I would like to allow each score to be submitted with a comment
